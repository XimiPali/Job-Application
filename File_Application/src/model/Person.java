...
public class Person implements Serializable{
	...
	private AgeCategory ageCategory; // they are 3 string but they can only take one of two or three values
	private EmploymentCategory empCat;
	private String taxId;
	private boolean usCitizen;
    private Gender gender;
    
    public Person(int id2, String name, String occupation, AgeCategory ageCategory,
